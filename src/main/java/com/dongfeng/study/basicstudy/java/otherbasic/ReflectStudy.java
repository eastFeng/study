...
//            applicationExamples(goods);
    ...
    public static void nameInfo(){
        ...
        // getName返回的是Java内部使用的真正的名称 : com.dongfeng.study.basicstudy.java.otherbasic.Goods
        ...
        // getCanonicalName返回的名称更为友好 : com.dongfeng.study.basicstudy.java.otherbasic.Goods
    ...
    public static Class<?> getGoodsClass(){
        try {
            return Class.forName("com.dongfeng.study.basicstudy.java.otherbasic.Goods");

...
public class TreeMap<K,V> extends AbstractMap<K,V> {
     ...
     * @param <V> 值的类型
     */
    static final class Entry<K,V> implements com.dongfeng.study.basicstudy.sourcecode.java8.util.Map.Entry<K,V> {
        // 键
        K key;
        // 值
        V value;
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof com.dongfeng.study.basicstudy.sourcecode.java8.util.Map.Entry)) {
                return false;
            }

            com.dongfeng.study.basicstudy.sourcecode.java8.util.Map.Entry<?,?> e = (com.dongfeng.study.basicstudy.sourcecode.java8.util.Map.Entry<?,?>)o;
    ...
    public TreeMap(com.dongfeng.study.basicstudy.sourcecode.java8.util.Map<? extends K, ? extends V> m) {
        comparator = null;
        putAll(m);
    }
...
//        }
    ...
    static <K,V> com.dongfeng.study.basicstudy.sourcecode.java8.util.Map.Entry<K,V> exportEntry(TreeMap.Entry<K,V> e) {
        return (e == null) ? null :

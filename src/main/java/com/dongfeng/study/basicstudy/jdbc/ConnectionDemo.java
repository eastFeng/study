 ...
 *
 * java.sql.Driver: 是所有JDBC驱动程序需要实现的接口,这个接口是提供给数据库厂商使用的，不同数据库厂商提供不同的实现。
 *
 * @author eastFeng
...
//        Driver driver = new com.mysql.jdbc.Driver();
     ...
     * 方式一种的缺点:  获取Driver实现类对象的时候引入了第三方的类
     * @throws Exception
     */
    ...
    /**
     * 获取数据库连接方式四: 对方式三的优化, 只用加载驱动而不用显示的注册驱动;
     *
     * MySQ驱动类(com.mysql.jdbc.Driver)源码:

 ...
 * <p> 在代理模式中，创建具有现有对象的对象，以便向外界提供功能接口。
 *
 * <p> 意图：为其他对象提供一种代理以【控制对这个对象的访问】。
 *
 * <p> 主要解决：在直接访问对象时带来的问题，比如说：要访问的对象在远程的机器上。在面向对象系统中，
 ...
 * <p> 应用实例：
 * <p> 1、Windows 里面的快捷方式。
 * <p> 2、猪八戒去找高翠兰结果是孙悟空变的，可以这样理解：把高翠兰的外貌抽象出来，高翠兰本人和孙悟空都实现了这个接口，猪八戒访问高翠兰的时候看不出来这个是孙悟空，所以说孙悟空是高翠兰代理类。
 * <p> 3、买火车票不一定在火车站买，也可以去代售点。
 * <p> 4、一张支票或银行存单是账户中资金的代理。支票在市场交易中用来代替现金，并提供对签发人账号上资金的控制。
 * <p> 5、spring aop。
 *

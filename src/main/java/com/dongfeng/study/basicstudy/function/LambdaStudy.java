package com.dongfeng.study.basicstudy.function;

import cn.hutool.core.io.LineHandler;
import com.dongfeng.study.basicstudy.AbstractStudy;
import com.dongfeng.study.basicstudy.Goods;
...
public class LambdaStudy {
    ...
    public static void introduceLambdaMotive(){
        /*
         * 我们先从清单 1 中的代码开始谈起。该示例的功能非常简单，只是启动一个线程并输出文本到控制台。
         * 虽然该 Java 程序一共有 6 行代码，但真正有价值的只有其中的第 4 行。
         * 剩下的代码全部都是为了满足语法要求而必须添加的冗余代码。
         * 代码中的第 1 到第 6 行，使用 java.lang.Runnable 接口的实现创建了一个新的
         * java.lang.Thread 对象，并调用 Thread 对象的 start 方法来启动它。Runnable 接口是
         * 通过一个匿名内部类实现的。
         */
    ...
    public static void targetType(){
         ...
         * 举例来说，Lambda 表达式() -> System.out.println("Hello World!")可以出现在任何要求一个函数式接口实例的上下文中，
...
//        study.use(() -> System.out.println("hello world"));  // 会出现编译错误 Ambiguous method call.
    ...
    public static void lambdaSyntax(){
         ...
         * first 和 second 是什么？他们都是字符串。Java 是一种强类型语言，所以我们要指定他们的类型：

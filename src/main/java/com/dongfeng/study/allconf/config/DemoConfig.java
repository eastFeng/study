...
public class DemoConfig {
    ...
    /**
     * <p> {@link org.springframework.stereotype.Component}是类级别的注释，{@link Bean}是方法级别的，
     * 所以{@link org.springframework.stereotype.Component}只是类的源代码可编辑时的一个选项。
     * {@link Bean}总是可以使用的，但是它更冗长。
     *
     * <p> {@link org.springframework.stereotype.Component}与Spring的自动检测兼容，但{@link Bean}需要手动实例化类。
     *
